...
CHALLENGES = {
    "REST Fundamentals": [
        ...
        ("Specific Retrieval", 'Fetch the book "API Design Patterns" by its ID.', "GET", "/api/v1/sandbox/books/42", None, None, None, 50,
         ["First, list all books to find its ID", "REST APIs use path parameters like /resource/{id}", "The book ID is 42", "GET /api/v1/sandbox/books/42", "Full path: GET /api/v1/sandbox/books/42"],
         "/api/v1/sandbox/books", 120),

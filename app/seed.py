...
CHALLENGES = {
    "REST Fundamentals": [
        ...
        ("Fix the Typo", "Update book 4 with PUT.", "PUT", "/api/v1/sandbox/books/4", {"Content-Type": "application/json"}, None,
         {"title": "Refactoring", "author": "Martin Fowler", "year": 2018}, 50,
         ["PUT replaces the entire resource", "Need Content-Type header", "All fields are required", "PUT /books/4", "Body: title, author, year for book 4"],
         "/api/v1/sandbox/books", None),
